...
class CitationExpander:
    ...
    def expand(
        ...
        *,
        ...
        """Apply gain, semantic-BFS, or RRF-BFS citation selection."""
        if (
            max_depth < 0
    ...
    def _expand_gain(
        ...
        *,
        ...
        for depth in range(1, max_depth + 1):
            if citation_count >= max_citation_chunks or not frontier:
                break
            ...
            added_by_group, next_frontier = self._select_gain_candidates(
                ...
                facets,
                min_gain,
                max_citation_chunks - citation_count,
                depth,
                selected,
                selected_ids,
            )
            citation_count += len(next_frontier)
