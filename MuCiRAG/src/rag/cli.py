"""Command-line entry point for one MuCiRAG question."""
...
from .service import MuCiRAGService


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run MuCiRAG over the prepared 3GPP corpus.")
...
def main() -> int:
    ...
    result = MuCiRAGService().run(" ".join(args.question), include_answer=not args.no_answer)
